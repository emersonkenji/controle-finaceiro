                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                            <Link href={route('financial.receivables.show', receivable.id)}>
                                <Eye className="mr-2 h-4 w-4" />
                                <span>Visualizar</span>
                            </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                            <Link href={route('financial.receivables.edit', receivable.id)}>
                        ...
                        <DropdownMenuItem
                            onClick={() => {
                                if (confirm('Tem certeza que deseja excluir esta conta?')) {
                                    router.delete(route('financial.receivables.destroy', receivable.id));
                                }
                            }}
                        >
