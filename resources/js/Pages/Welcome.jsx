...
export default function Welcome({ auth, laravelVersion, phpVersion, canLogin }) {
                ...
                <div className="relative flex min-h-screen flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        ...
                        <footer className="py-16 text-sm text-center text-black dark:text-white/70">
                            Laravel v{laravelVersion} (PHP v{phpVersion} ) t{canLogin}
                            <Button>
                                <Link href={route(canLogin ? 'dashboard' : 'login')}>
                                    Acessar
                                </Link>
                            </Button>
                        </footer>
